...
namespace glr
{
  ...
  void Color::fromRGBf(const float r, const float g, const float b)
  {
  ...
  void Color::fromRGBAf(const float r, const float g, const float b, const float a)
  {
    this->red = (ColorFmt) (bound<float>(r, 0.0f, 1.0f) * s_ui16Max);
    this->green = (ColorFmt) (bound<float>(g, 0.0f, 1.0f) * s_ui16Max);
    this->blue = (ColorFmt) (bound<float>(b, 0.0f, 1.0f) * s_ui16Max);
  ...
  void Color::fromRGBui8(const uint8_t r, const uint8_t g, const uint8_t b)
  {
  ...
  void Color::fromRGBAui8(const uint8_t r, const uint8_t g, const uint8_t b, const uint8_t a)
  {
    this->red = (ColorFmt) (r * 256);
    this->green = (ColorFmt) (g * 256);
    this->blue = (ColorFmt) (b * 256);
  ...
  void Color::fromRGBui16(const uint16_t r, const uint16_t g, const uint16_t b)
  {
    this->red = r;
    this->green = g;
    this->blue = b;
  ...
  void Color::fromRGBAui16(const uint16_t r, const uint16_t g, const uint16_t b, const uint16_t a)
  {
    this->red = r;
    this->green = g;
    this->blue = b;
  ...
  void Color::fromHex(const uint32_t hex)
  {
  ...
  void Color::fromWeb(const std::string& color)
  {
    ...
    const uint32_t conv = (uint32_t)(std::strtol(color.data() + 1, nullptr, 16));
    switch(color.size())
    {
      default:
        printf("Color::fromWeb: Invalid color formatting.\n");
